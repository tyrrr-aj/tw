...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Plotter bookwiseProducersPlotter = new Plotter("Bookwise: Producers");
        Plotter bookwiseConsumersPlotter = new Plotter("Bookwise: Consumers");
        ...
        for (int bufferSize = 1000; bufferSize <= 100000; bufferSize *= 10) {
            for (int PCNumber = 10; PCNumber <= 1000; PCNumber *= 10) { // PCNumber - number of Producers and Consumers
                ...
                ICountingBuffer buffer = new BookwiseCountingBuffer(bufferSize, timeout);
                ...
                bookwiseProducersPlotter.addSeries(
                        String.format("bufferSize %d, Producers and Consumers %d", bufferSize, PCNumber),
                        producersSummarizer.getMeans()
                );
                bookwiseConsumersPlotter.addSeries(
                        String.format("bufferSize %d, Producers and Consumers %d", bufferSize, PCNumber),
                        consumersSummarizer.getMeans()
                );
                System.out.printf("Bookwise: buffer %d, PC %d tested%n", bufferSize, PCNumber);
            }
        }
        ...
        bookwiseProducersPlotter.plot();
        bookwiseConsumersPlotter.plot();
    }
}
